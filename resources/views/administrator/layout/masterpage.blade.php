...
<head>
    ...
    <title>پنل ادمین سایت فروشگاهی</title>
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        <li><a href="{{route('atrributes.index')}}"><i class="fa fa-circle-o"></i>لیست ویزگی ها</a></li>
                        <li><a href="{{route('atrributes-value.index')}}"><i class="fa fa-circle-o"></i>مقدار ویزگی ها</a></li>
                    </ul>
                </li>
                <li class="treeview">
                    <a href="#">
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        <li><a href="{{route('coupons.index')}}"><i class="fa fa-circle-o"></i>لیست کد های تخفیف</a></li>
                    </ul>
                </li>
                <li class="treeview">
                    <a href="#">
                    ...
                    <ul class="treeview-menu">
                        <li><a href="{{route('orders.adminPanel')}}"><i class="fa fa-circle-o"></i>لیست سفارشات</a></li>
                    </ul>
                </li>
