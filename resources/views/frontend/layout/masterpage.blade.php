            ...
            <div class="container">
                <div class="row"><span class="drop-icon visible-sm visible-xs"><i
                    ...
                    <div id="top-links" class="nav pull-right flip">
                        <ul>
                            @if(Auth::check())
                                <li><a href="{{route('profile')}}">پروفایل کاربری</a></li>
            ...
            <div class="container">
                <div class="table-container">
                    ...
                    <div class="col-table-cell col-lg-6 col-md-6 col-sm-12 col-xs-12 inner">
                        <div id="logo"><a href="index.html"><img class="img-responsive" src="/image/logo.png"
                            ...
                            <ul class="dropdown-menu">
                                    ...
                                    <table class="table">
                                        @if(Session::has('cart'))
                                            @foreach(Session::get('cart')->items as $product)
                                                <tbody>
                                                <tr>
                                                    <td class="text-center" style="width: 20%"><a href="product.html"><img class="img-thumbnail" src="{{$product['item']->photos[0]->path}}"></a></td>
                                                    <td class="text-left"><a>{{$product['item']->title}}</a></td>
                                                    <td class="text-right">x {{$product['qty']}}</td>
                                                    <td class="text-right">{{$product['price']}} تومان</td>
                                                    <td class="text-center">
                                                        <a class="btn btn-danger btn-xs remove" title="حذف"
                                                    ...
                                                    <form id="remove_item_{{$product['item']->id}}" action="{{ route('remove.cart',['id' => $product['item']->id]) }}" method="POST"
                                                          style="display: none;">
                                                        @csrf
                                                    </form>
                                                </tr>
                                ...
                                <li>
                                    <div>
                                        ...
                                        <p class="checkout"><a href="{{route('cart.cart')}}" class="btn btn-primary"><i
            ...
            <div class="container">
                <div class="collapse navbar-collapse navbar-ex1-collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li><a class="home_link" title="پوشاک" href="{{ route('category.index', ['id' =>7]) }}">پوشاک</a></li>
