                    ...
                    <div class="row product-info">
                        <div class="col-sm-6">
                            ...
                            <div class="image-additional" id="gallery_01">
                                @foreach($product->photos as $photo)
                                    <a class="thumbnail" href="#" data-zoom-image="{{$photo->path}}"
                                       data-image="{{$photo->path}}" title="{{$product->title}}">
                                        <img src="{{$photo->path}}" title="{{$product->title}}"
                                             alt="{{$product->title}}"/>
                                    </a>
                                @endforeach
                        ...
                        <div class="col-sm-6">
                            ...
                            <ul class="price-box">
                                <li class="price" itemprop="offers" itemscope itemtype="http://schema.org/Offer">
                                    @if($product->discount_price)
                                        <span
                                            class="price-old">{{$product->price}}  تومان
                                        </span>
                                        <span
                                            itemprop="price">{{$product->discount_price}} تومان
                            ...
                            <div id="product">
                                ...
                                <div class="cart">
                                    <div>
                                        <a type="button" href="{{route('add.cart' ,['id' => $product->id])}}"
                                           id="button-cart" class="btn btn-primary btn-lg">افزودن به
                                            سبد
                                        </a>
                                    </div>
                                </div>
                            ...
                            <div class="rating" itemprop="aggregateRating" itemscope
                                ...
                                <p><span class="fa fa-stack"><i class="fa fa-star fa-stack-1x"></i><i
                                    ...
                                    <span class="fa fa-stack"><i class="fa fa-star fa-stack-1x"></i><i
                                            class="fa fa-star-o fa-stack-1x"></i></span> <span class="fa fa-stack"><i
                                            class="fa fa-star fa-stack-1x"></i><i class="fa fa-star-o fa-stack-1x"></i></span>
                                    <span class="fa fa-stack"><i class="fa fa-star-o fa-stack-1x"></i></span> <a
                    ...
                    <div class="tab-content">
                        ...
                        <div id="tab-specification" class="tab-pane">
                            <table class="table table-bordered">
                                @foreach($product->atrributevalues as $atrribute)
                                    <tbody>
                                    <tr>
                                        <td>{{$atrribute->atrributeGroup->title}}</td>
